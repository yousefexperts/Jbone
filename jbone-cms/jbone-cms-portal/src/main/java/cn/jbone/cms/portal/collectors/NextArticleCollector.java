...
@Repository("nextArticleCollector")
public class NextArticleCollector implements IDataCollector {

    @Autowired
    private ArticleService articleService;

    private String DATA_KEY = "nextArticle";
    ...
    public void collect(DataCollectorContext context) {
        ...
        articleSearchDO.addCondition(new SearchConditionDO("addTime",SearchConditionDO.Operator.GREATER_THAN,conditionValue));
        articleSearchDO.addSort(new SearchSortDO("addTime", SearchSortDO.Direction.ASC));
